...
```{r}
#Seeing the abundances of dif species sampled
...
```{r}
#Looking at Species Richness at different Latitudes
predprey %>%
 group_by(Latitude) %>%
 summarize(Predator_Species_Richness=length(unique(Predator_common_name))) %>% 
